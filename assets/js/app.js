...
UIinit.UserLeft = function(a) {
    $("#top_right_dropdown").prepend(Templates.user_left({
        user: a
    }))
};
    ...
    var b = Backbone.View.extend({
        ...
        render: function() {
            ...
            $("#trending_song_list").html(this.songs.map(function(u, v) {
                ...
                q += "background-image:url(" + o + "), url(/static/placeholder.jpg);";
                q += "background-size:" + w + ";";
...
var Artist = Backbone.Model.extend({
    ...
    parse: function(a) {
        setTimeout(function(){ jQuery("#load_artist_song_tab").click(); }, 300);
        return a.artist
    }
});
